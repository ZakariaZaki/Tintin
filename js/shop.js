$(document).ready(function() {
  ...
  var products = {
    'Statue' : ['Statue', "Tintin/Kuifje statue! Get it while it lasts.", 9.99, 'img/tintin.jpg', 9.99],
    'Statue2' : ['Statue', "Tintin/Kuifje statue! Get it while it lasts.", 9.99, 'img/tintin.jpg', 9.99],
    'Statue3' : ['Statue', "Tintin/Kuifje statue! Get it while it lasts.", 9.99, 'img/tintin.jpg', 9.99],
    'Statue4' : ['Statue', "Tintin/Kuifje statue! Get it while it lasts.", 9.99, 'img/tintin.jpg', 9.99],
    'Statue5' : ['Statue', "Tintin/Kuifje statue! Get it while it lasts.", 9.99, 'img/tintin.jpg', 9.99],
    'Statue6' : ['Statue', "Tintin/Kuifje statue! Get it while it lasts.", 9.99, 'img/tintin.jpg', 9.99]
  };
  ...
  //  Formats number into dollar/euro format
